      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="hidden lg:flex w-full h-full">
          ...
          <div className="w-1/4 flex flex-col border-r border-gray-200 h-full" style={{ backgroundColor: '#F5F1EC' }}>
            ...
            {/* Chat Input - Fixed at bottom - FIXED BUTTON POSITIONING */}
            <div className="p-6 border-t border-gray-200 flex-shrink-0">
              <div className="chat-input-container">
                ...
                <button
                  ...
                  className="input-button w-8 h-8 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white rounded-full flex items-center justify-center"
                >
                  {isRefining ? (
      ...
      {isChatOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 rounded-t-2xl max-h-[80vh] flex flex-col animate-slide-up" style={{ backgroundColor: '#F5F1EC' }}>
            ...
            {/* Input Area - FIXED BUTTON POSITIONING */}
